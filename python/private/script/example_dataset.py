...
dis_videos = [
    ...
    {'content_id':1, 'asset_id': 0, 'dmos':100,  'path':config.ROOT+'/resource/yuv/flat_1920_1080_0.yuv'}, # ref
    {'content_id':1, 'asset_id': 1, 'dmos':80,  'path':config.ROOT+'/resource/yuv/flat_1920_1080_10.yuv'},
]
