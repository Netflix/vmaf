...
class FeatureExtractorTest(MyTestCase):
    ...
    def test_run_integer_motion_fextractor(self):
        ...
        self.assertAlmostEqual(results[0]['integer_motion_feature_motion2_score'], 3.8943597291666667, places=8)
        self.assertAlmostEqual(results[1]['integer_motion_feature_motion2_score'], 3.8943597291666667, places=8)
        self.assertAlmostEqual(results[0]['integer_motion_feature_motion3_score'], 3.9897647708333337, places=8)
        self.assertAlmostEqual(results[1]['integer_motion_feature_motion3_score'], 3.9897647708333337, places=8)
        with self.assertRaises(KeyError):
    ...
    def test_run_integer_motion_fextractor_with_debug(self):
        ...
        self.assertAlmostEqual(results[0]['integer_motion_feature_motion2_score'], 3.8943597291666667, places=8)
        self.assertAlmostEqual(results[1]['integer_motion_feature_motion2_score'], 3.8943597291666667, places=8)
        self.assertAlmostEqual(results[0]['integer_motion_feature_motion_score'], 4.048813375, places=8)
        self.assertAlmostEqual(results[1]['integer_motion_feature_motion_score'], 4.048813375, places=8)
        self.assertAlmostEqual(results[0]['integer_motion_feature_motion3_score'], 3.9897647708333337, places=8)
        self.assertAlmostEqual(results[1]['integer_motion_feature_motion3_score'], 3.9897647708333337, places=8)
    ...
    def test_run_integer_motion_fextractor_12bit(self):
        ...
        self.assertAlmostEqual(results[0]['integer_motion_feature_motion2_scores'][1], 4.214324, places=8)
        self.assertAlmostEqual(results[0]['integer_motion_feature_motion2_scores'][2], 4.214324, places=8)
        self.assertAlmostEqual(results[0]['integer_motion_feature_motion2_score'], 2.8095493333333335, places=8)
        self.assertAlmostEqual(results[0]['integer_motion_feature_motion3_score'], 4.336030000000001, places=8)
        self.assertAlmostEqual(results[0]['integer_motion_feature_motion3_scores'][0], 4.579442, places=8)
        self.assertAlmostEqual(results[0]['integer_motion_feature_motion3_scores'][1], 4.214324, places=8)
        self.assertAlmostEqual(results[0]['integer_motion_feature_motion3_scores'][2], 4.214324, places=8)
        self.assertAlmostEqual(results[1]['integer_motion_feature_motion2_score'], 2.8095493333333335, places=8)
        self.assertAlmostEqual(results[1]['integer_motion_feature_motion3_score'], 4.336030000000001, places=8)
    ...
    def test_run_float_vif_fextractor_with_debug(self):
        ...
        self.assertAlmostEqual(results[0]['float_VIF_feature_vif_scale1_score'], 0.7674898958333333, places=5)
        self.assertAlmostEqual(results[0]['float_VIF_feature_vif_scale2_score'], 0.8630880833333334, places=5)
        self.assertAlmostEqual(results[0]['float_VIF_feature_vif_scale3_score'], 0.9156987499999999, places=6)
        self.assertAlmostEqual(results[1]['float_VIF_feature_vif_scale0_score'], 1.0, places=5)
        self.assertAlmostEqual(results[1]['float_VIF_feature_vif_scale1_score'], 1.0, places=5)
        self.assertAlmostEqual(results[1]['float_VIF_feature_vif_scale2_score'], 1.0, places=5)
        self.assertAlmostEqual(results[1]['float_VIF_feature_vif_scale3_score'], 1.0, places=5)
    ...
    def test_run_float_vif_fextractor_with_vif_skip_scale0(self):
        ...
        self.assertAlmostEqual(results[0]['float_VIF_feature_vif_scale3_ssclz_score'], 0.9156987499999999, places=6)
    ...
    def test_run_float_vif_fextractor_with_vif_scale1_min_val(self):
        ...
        self.fextractor.run(parallelize=True)
        results = self.fextractor.results
        self.assertEqual(results[0]['float_VIF_feature_vif_scale0_s1miv_0.987654_score'], 0.3636628333333333)
        ...
        self.assertAlmostEqual(results[0]['float_VIF_feature_vif_scale3_s1miv_0.987654_score'], 0.9156987499999999, places=6)
    ...
    def test_run_float_vif_fextractor_with_vif_scale2_min_val(self):
        ...
        results = self.fextractor.results
        print(results[0])
        self.assertEqual(results[0]['float_VIF_feature_vif_scale0_s2miv_0.987654_score'], 0.3636628333333333)
        ...
        self.assertAlmostEqual(results[0]['float_VIF_feature_vif_scale3_s2miv_0.987654_score'], 0.9156987499999999, places=6)
    ...
    def test_run_float_vif_fextractor_with_vif_scale3_min_val(self):
        ...
        results = self.fextractor.results
        print(results[0])
        self.assertEqual(results[0]['float_VIF_feature_vif_scale0_s3miv_0.987654_score'], 0.3636628333333333)
    ...
    def test_run_float_adm_fextractor_barten_csf_scale_vhd_anw(self):
        ...
        self.assertAlmostEqual(results[0]['float_ADM_feature_adm_scale2_scfd_0.001586_csf_1_scf_0.002893_nw_0.000625_score'], 0.9243578958333334, places=6)
    ...
    def test_run_float_adm_fextractor_barten_csf_scale_coeffs_1d5h(self):
        ...
        self.assertAlmostEqual(results[0]['float_ADM_feature_adm_scale2_scfd_0.001586_csf_1_scf_0.002893_nvd_1.5_score'], 0.9267192083333334, places=6)
    ...
    def test_run_float_adm_fextractor_barten_csf_scale_coeffs_4d5h(self):
        ...
        self.assertAlmostEqual(results[0]['float_ADM_feature_adm_scale2_scfd_0.001586_csf_1_scf_0.002893_nvd_4.5_score'], 0.9357725833333332, places=6)
    ...
    def test_run_float_adm_fextractor_barten_csf_scale_coeffs_2_3h_rdh_1080(self):
        ...
        self.assertAlmostEqual(results[0]['float_ADM_feature_adm_scale2_scfd_0.05_csf_1_scf_0.1_score'], 0.9227575625000001, places=6)
    ...
    def test_run_float_adm_fextractor_barten_csf_noise_weight(self):
        ...
        self.assertAlmostEqual(results[0]['float_ADM_feature_adm_scale2_csf_1_nw_0.00015625_score'], 0.9165525625000001, places=6)
    ...
    def test_run_float_adm_fextractor_barten_csf_nvd_1d5(self):
        ...
        self.assertAlmostEqual(results[0]['float_ADM_feature_adm_scale2_csf_1_nvd_1.5_score'], 0.9165624583333333, places=6)
    ...
    def test_run_integer_adm_fextractor_akiyo_multiply_enhn_gain_limit_1(self):
        ...
        self.assertAlmostEqual(results[0]['integer_ADM_feature_adm3_egl_1_score'], 0.971875, places=6)  # float 0.971874
