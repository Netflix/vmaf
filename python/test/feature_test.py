...
class FeatureTest(unittest.TestCase):
    ...
    REF_YUV = config.ROOT + "/python/test/resource/yuv/src01_hrc00_576x324.yuv"
    DIS_YUV = config.ROOT + "/python/test/resource/yuv/src01_hrc01_576x324.yuv"
    YUV_FMT = "yuv420p"
    YUV_WIDTH = 576
    YUV_HEIGHT = 324
...
class FeatureTestYuv422p10le(unittest.TestCase):
    ...
    REF_YUV = config.ROOT + "/python/test/resource/yuv/src01_hrc00_576x324.yuv422p10le.yuv"
    DIS_YUV = config.ROOT + "/python/test/resource/yuv/src01_hrc01_576x324.yuv422p10le.yuv"
    YUV_FMT = "yuv422p10le"
    YUV_WIDTH = 576
    YUV_HEIGHT = 324
...
class CornerCaseTest(unittest.TestCase):
    ...
    def test_checkerboard_identical(self):
        ...
        ref_yuv = config.ROOT + "/python/test/resource/yuv/checkerboard_1920_1080_10_3_0_0.yuv"
        dis_yuv = config.ROOT + "/python/test/resource/yuv/checkerboard_1920_1080_10_3_0_0.yuv"
        yuv_fmt = "yuv420p"
        yuv_width = 1920
        yuv_height = 1080
    ...
    def test_checkerboard_shifted_by_1(self):
        ...
        ref_yuv = config.ROOT + "/python/test/resource/yuv/checkerboard_1920_1080_10_3_0_0.yuv"
        dis_yuv = config.ROOT + "/python/test/resource/yuv/checkerboard_1920_1080_10_3_1_0.yuv"
        yuv_fmt = "yuv420p"
        yuv_width = 1920
        yuv_height = 1080
        cmd = self.CMD_TEMPLATE.format(vmaf=ExternalProgram.vmaf, fmt=yuv_fmt, ref=ref_yuv,
    ...
    def test_checkerboard_opposite(self):
        ...
        ref_yuv = config.ROOT + "/python/test/resource/yuv/checkerboard_1920_1080_10_3_0_0.yuv"
        dis_yuv = config.ROOT + "/python/test/resource/yuv/checkerboard_1920_1080_10_3_10_0.yuv"
        yuv_fmt = "yuv420p"
        yuv_width = 1920
        yuv_height = 1080
        cmd = self.CMD_TEMPLATE.format(vmaf=ExternalProgram.vmaf, fmt=yuv_fmt, ref=ref_yuv,
    ...
    def test_flat_identical(self):
        ...
        ref_yuv = config.ROOT + "/python/test/resource/yuv/flat_1920_1080_0.yuv"
        dis_yuv = config.ROOT + "/python/test/resource/yuv/flat_1920_1080_0.yuv"
        yuv_fmt = "yuv420p"
        yuv_width = 1920
        yuv_height = 1080
        cmd = self.CMD_TEMPLATE.format(vmaf=ExternalProgram.vmaf, fmt=yuv_fmt, ref=ref_yuv,
    ...
    def test_flat_value10(self):
        ...
        ref_yuv = config.ROOT + "/python/test/resource/yuv/flat_1920_1080_0.yuv"
        dis_yuv = config.ROOT + "/python/test/resource/yuv/flat_1920_1080_10.yuv"
        yuv_fmt = "yuv420p"
        yuv_width = 1920
        yuv_height = 1080
        cmd = self.CMD_TEMPLATE.format(vmaf=ExternalProgram.vmaf, fmt=yuv_fmt, ref=ref_yuv,
