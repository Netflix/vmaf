...
class FeatureExtractorTest(unittest.TestCase):
    ...
    def test_run_float_vif_fextractor_akiyo_multiply(self):
        ...
        self.fextractor.run()
        results = self.fextractor.results
        self.assertAlmostEqual(results[0]['float_VIF_feature_vif_scale0_score'], 1.0522544319369052, places=6)
        self.assertAlmostEqual(results[0]['float_VIF_feature_vif_scale1_score'], 1.0705609423182443, places=6)
