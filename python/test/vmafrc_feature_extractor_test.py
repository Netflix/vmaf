...
class FeatureExtractorTest(unittest.TestCase):
    ...
    def test_run_integer_adm_fextractor_akiyo_multiply_enhn_gain_limit_1(self):
        ...
        self.fextractor.run()
        results = self.fextractor.results
        self.assertAlmostEqual(results[0]['integer_ADM_feature_adm2_score'], 0.9574308606115118, places=6)
    ...
    def test_run_integer_adm_fextractor_akiyo_multiply_enhn_gain_limit_1d2(self):
        ...
        self.fextractor.run()
        results = self.fextractor.results
        self.assertAlmostEqual(results[0]['integer_ADM_feature_adm2_score'], 1.116595, places=6)
