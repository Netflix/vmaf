...
class VmafossexecQualityRunnerTest(unittest.TestCase):
    ...
    def test_run_vmafossexec_runner_akiyo_multiply_no_enhn_gain_model_json(self):
        ...
        self.assertAlmostEqual(results[0]['VMAFOSSEXEC_VMAF_integer_feature_adm2_score_adm_enhn_gain_limit_1.00_score'], 0.9574308606115118, places=4)  # 1.116691484215469
        self.assertAlmostEqual(results[0]['VMAFOSSEXEC_VMAF_integer_feature_vif_scale0_score_vif_enhn_gain_limit_1.00_score'], 0.983699512450884, places=4)  # 1.0522544319369052
        self.assertAlmostEqual(results[0]['VMAFOSSEXEC_VMAF_integer_feature_vif_scale1_score_vif_enhn_gain_limit_1.00_score'], 0.9974276726830457, places=4)  # 1.0705609423182443
        self.assertAlmostEqual(results[0]['VMAFOSSEXEC_VMAF_integer_feature_vif_scale2_score_vif_enhn_gain_limit_1.00_score'], 0.9984692380091739, places=4)  # 1.0731529493098957
        self.assertAlmostEqual(results[0]['VMAFOSSEXEC_VMAF_integer_feature_vif_scale3_score_vif_enhn_gain_limit_1.00_score'], 0.999146211879154, places=4)  # 1.0728060231246508
