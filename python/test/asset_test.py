...
class AssetTest(unittest.TestCase):
    ...
    def test_workdir(self):
        import re
        asset = Asset(dataset="test", content_id=0, ref_path="", dis_path="",
    ...
    def test_ref_dis_str(self):
        ...
        self.assertEquals(
            asset.to_string(),
            "test_0_refvideo_720x480_2to2_vs_disvideo_720x480_2to2_q_720x480"
        )
        self.assertEquals(
            asset.to_string_compact(),
            "test_0_disvideo_720x480_2to2_q_720x480"
        )
        self.assertEquals(
            str(asset),
            "test_0_disvideo_720x480_2to2_q_720x480"
        ...
        self.assertEquals(
            asset.to_string(),
            "test_0_refvideo_720x480_vs_disvideo_720x480_q_720x480"
        )
        self.assertEquals(
            asset.to_string_compact(),
            "test_0_disvideo_720x480_q_720x480"
        )
        self.assertEquals(
            str(asset),
            "test_0_disvideo_720x480_q_720x480"
        ...
        self.assertEquals(
            asset.to_string(),
            "test_0_refvideo_720x480_vs_disvideo_720x480_q_1920x1080"
        )
        self.assertEquals(
            asset.to_string_compact(),
            "test_0_disvideo_720x480_q_1920x1080"
        )
        self.assertEquals(
            str(asset),
            "test_0_disvideo_720x480_q_1920x1080"
    ...
    def test_workfile_path(self):
        ...
        expected_ref_workfile_path_re = \
            r"^workdir/[a-zA-Z0-9-]+/ref_test_0_disvideo_720x480_2to2_q_1920x1080$"
        expected_dis_workfile_path_re = \
            r"^workdir/[a-zA-Z0-9-]+/dis_test_0_disvideo_720x480_2to2_q_1920x1080"
