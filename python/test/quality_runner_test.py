...
class QualityRunnerTest(MyTestCase):
    ...
    def test_run_vmaf_runner(self):
        ...
        self.assertAlmostEqual(
            results[1]["VMAF_integer_feature_vif_scale0_score"], 1.00000001415, places=4
        )
        self.assertAlmostEqual(
            results[1]["VMAF_integer_feature_vif_scale1_score"], 0.99999972612, places=4
        )
        self.assertAlmostEqual(
            results[1]["VMAF_integer_feature_vif_scale2_score"], 0.999999465724, places=4
        )
        self.assertAlmostEqual(
    ...
    def test_run_vmaf_runner_v061(self):
        ...
        self.assertAlmostEqual(
            results[1]["VMAF_feature_vif_scale2_score"], 0.999999465724, places=4
        )
        self.assertAlmostEqual(
    ...
    def test_run_vmaf_runner_checkerboard(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_integer_feature_adm2_score"], 0.053996580527295335, places=4
        )

        self.assertAlmostEqual(
            results[1]["VMAF_integer_feature_vif_scale0_score"], 0.999998395234, places=4
        )
        self.assertAlmostEqual(
            results[1]["VMAF_integer_feature_vif_scale1_score"], 1.00000122625, places=4
        )
        self.assertAlmostEqual(
            results[1]["VMAF_integer_feature_vif_scale2_score"], 0.999998263056, places=4
        )
        self.assertAlmostEqual(
            results[1]["VMAF_integer_feature_vif_scale3_score"], 1.0000000801, places=4
        )
        self.assertAlmostEqual(
        ...
        self.assertAlmostEqual(
            results[2]["VMAF_integer_feature_vif_scale0_score"], 0.112931470868, places=4
        )
        self.assertAlmostEqual(
            results[2]["VMAF_integer_feature_vif_scale1_score"], 0.2983721613615637, places=4
        )
        self.assertAlmostEqual(
            results[2]["VMAF_integer_feature_vif_scale2_score"], 0.33743204896754614, places=4
        )
        self.assertAlmostEqual(
            results[2]["VMAF_integer_feature_vif_scale3_score"], 0.496419716304, places=4
        )
        self.assertAlmostEqual(
    ...
    def test_run_vmaf_runner_with_norm_type_none(self):
        ...
        self.runner = VmafQualityRunner(
            ...
            result_store=self.result_store,
            optional_dict={
                "model_filepath": VmafConfig.model_path(
                    "other_models", "nflxtrain_norm_type_none.json"
                ),
            },
            optional_dict2=None,
        )
        ...
        self.runner = EnsembleVmafQualityRunner(
            ...
            optional_dict={
                "model_filepath": [
                    ...
                    VmafConfig.model_path("other_models", "vmaf_v0.6.0.json"),
                ],
            },
        )
        self.runner.run(parallelize=False)
    ...
    def test_run_vmaf_runner_with_transform_score(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_adm_scale0_score"], 0.23738393128710478, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_adm_scale1_score"], 0.08524788663335138, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_adm_scale2_score"], 0.024058909404945077, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_adm_scale3_score"], 0.018034879735107798, places=4
        )
    ...
    def test_run_bootstrap_vmaf_runner(self):
        ...
        self.runner = BootstrapVmafQualityRunner(
            ...
            optional_dict={
                "model_filepath": VmafConfig.test_resource_path(
                    "model", "vmafplus_v0.5.2boot_test.json"
                ),
            },
        )
        self.runner.run(parallelize=False)
        ...
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_bagging_score"], 75.11496350766362, places=1
        )
        self.assertAlmostEqual(
            results[1]["BOOTSTRAP_VMAF_bagging_score"], 99.96504855577571, places=4
        )
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_stddev_score"], 0.6816714405308405, places=2
        )
        self.assertAlmostEqual(
            results[1]["BOOTSTRAP_VMAF_stddev_score"], 0.03947607207290399, places=4
        )
    ...
    def test_run_bootstrap_vmaf_runner_10models(self):
        ...
        self.runner = BootstrapVmafQualityRunner(
            ...
            optional_dict={
                "model_filepath": VmafConfig.test_resource_path(
                    "model", "vmafplus_v0.5.2boot_test2.json"
                ),
            },
        )
        self.runner.run(parallelize=False)
    ...
    def test_run_bagging_vmaf_runner(self):
        ...
        self.assertAlmostEqual(
            results[0]["BAGGING_VMAF_bagging_score"], 75.11496350766362, places=1
        )
        self.assertAlmostEqual(
            results[1]["BAGGING_VMAF_bagging_score"], 99.965048555775709, places=4
        )
        self.assertAlmostEqual(
            results[0]["BAGGING_VMAF_stddev_score"], 0.6816714405308405, places=2
        )
        self.assertAlmostEqual(
            results[1]["BAGGING_VMAF_stddev_score"], 0.03947607207290399, places=4
        )
    ...
    def test_run_niqe_runner(self):
        ...
        self.runner = NiqeQualityRunner(
            [asset1, asset2], None, fifo_mode=False, delete_workdir=True, result_store=None
        )
        self.runner.run(parallelize=False)
    ...
    def test_run_bootstrap_vmaf_runner_with_4k_1d5H_model(self):
        ...
        self.runner = BootstrapVmafQualityRunner(
            ...
            optional_dict={
                "model_filepath": VmafConfig.model_path(
                    "vmaf_4k_rb_v0.6.2", "vmaf_4k_rb_v0.6.2.json"
                ),
            },
        )
        self.runner.run(parallelize=False)
    ...
    def test_run_vmaf_runner_input160x90(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_integer_feature_vif_scale1_score"], 0.9576202275437821, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_integer_feature_vif_scale2_score"], 0.97696930627404, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_integer_feature_vif_scale3_score"], 0.9829181243754922, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_integer_feature_motion2_score"], 1.3596959375, places=2
        )
        self.assertAlmostEqual(
            results[0]["VMAF_integer_feature_adm2_score"], 0.9807496975664337, places=4
        )
        ...
        self.assertAlmostEqual(
            results[1]["VMAF_integer_feature_motion2_score"], 1.3596959375, places=2
        )
        self.assertAlmostEqual(results[1]["VMAF_integer_feature_adm2_score"], 1.0, places=4)
    ...
    def test_run_vmaf_runner_neg_mode(self):
        ...
        with self.assertRaises(KeyError):
            _ = results[0][
                "VMAF_integer_feature_vif_scale0_egl_1_score"
            ]  # egl_1 not in feature name
    ...
    def test_run_vmaf_runner_float_neg_mode(self):
        ...
        self.runner = VmafQualityRunner(
            ...
            optional_dict={
                "disable_clip_score": True,
                "model_filepath": VmafConfig.model_path("vmaf_float_v0.6.1neg.json"),
            },
        )
        self.runner.run(parallelize=False)
        results = self.runner.results
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale0_score"], 0.983699021577095, places=4
        )
        with self.assertRaises(KeyError):
    ...
    def test_run_vmaf_runner_nvd6(self):
        ...
        self.runner = VmafQualityRunner(
            ...
            result_store=None,
            optional_dict={
                "model_filepath": VmafConfig.test_resource_path("model", "vmaf_v0.6.1_nvd6.json")
            },
        )
        self.runner.run(parallelize=False)
    ...
    def test_run_vmaf_runner_float_nvd6(self):
        ...
        self.runner = VmafQualityRunner(
            ...
            optional_dict={
                "model_filepath": VmafConfig.test_resource_path(
                    "model", "vmaf_float_v0.6.1_nvd6.json"
                )
            },
        )
        self.runner.run(parallelize=False)
    ...
    def test_run_vmaf_runner_rdh540(self):
        ...
        self.runner = VmafQualityRunner(
            ...
            result_store=None,
            optional_dict={
                "model_filepath": VmafConfig.test_resource_path("model", "vmaf_v0.6.1_rdh540.json")
            },
        )
    ...
    def test_run_vmaf_runner_float_rdh540(self):
        ...
        self.runner = VmafQualityRunner(
            ...
            optional_dict={
                "model_filepath": VmafConfig.test_resource_path(
                    "model", "vmaf_float_v0.6.1_rdh540.json"
                )
            },
        )
        self.runner.run(parallelize=False)
    ...
    def test_run_vmaf_runner_rdh2160_nvd1d5(self):
        ...
        self.runner = VmafQualityRunner(
            ...
            optional_dict={
                "model_filepath": VmafConfig.test_resource_path(
                    "model", "vmaf_v0.6.1_rdh2160_nvd1d5.json"
                )
            },
        )
        self.runner.run(parallelize=False)
    ...
    def test_run_vmaf_runner_float_vifks3o2(self):
        ...
        self.runner = VmafQualityRunner(
            ...
            optional_dict={
                "model_filepath": VmafConfig.test_resource_path(
                    "model", "vmaf_float_v0.6.1_vifks3o2.json"
                )
            },
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale0_score"], 0.3861616186790285, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale1_score"], 0.8751422652833561, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale2_score"], 0.93652809011707, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale3_score"], 0.960645576541984, places=4
        )
        self.assertAlmostEqual(
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_score"], 82.59755475201645, places=3
        )  # pyvmaf: 82.54348985454762
        self.assertAlmostEqual(results[1]["VMAF_score"], 99.946416604585025, places=4)
    ...
    def test_run_vmaf_runner_float_vifks24o10(self):
        ...
        self.runner = VmafQualityRunner(
            ...
            optional_dict={
                "model_filepath": VmafConfig.test_resource_path(
                    "model", "vmaf_float_v0.6.1_vifks24o10.json"
                )
            },
            optional_dict2={"disable_avx": False},
        )
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale0_score"], 0.4060198772536953, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale1_score"], 0.9310491573906559, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale2_score"], 0.9642544958766202, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale3_score"], 0.9778185149650498, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_motion2_score"], 3.8943597291666667, places=4
        )
    ...
    def test_run_vmaf_runner_float_vifks360o97(self):
        ...
        self.runner = VmafQualityRunner(
            ...
            optional_dict={
                "model_filepath": VmafConfig.test_resource_path(
                    "model", "vmaf_float_v0.6.1_vifks360o97.json"
                )
            },
            optional_dict2={"disable_avx": False},
        )
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale0_score"], 0.4263953170358315, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale1_score"], 0.9611848614238534, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale2_score"], 0.977855114559413, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale3_score"], 0.9829845813744615, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_motion2_score"], 3.8943597291666667, places=4
        )
    ...
    def test_run_vmaf_runner_float_vifks1o2(self):
        ...
        self.runner = VmafQualityRunner(
            ...
            optional_dict={
                "model_filepath": VmafConfig.test_resource_path(
                    "model", "vmaf_float_v0.6.1_vifks1o2.json"
                )
            },
            optional_dict2={"disable_avx": False},
        )
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale0_score"], 0.3339409599929981, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale1_score"], 0.6084533246171074, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale2_score"], 0.7512585326506199, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale3_score"], 0.8742467113219519, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_motion2_score"], 3.8943597291666667, places=4
        )
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_score"], 71.24424733205448, places=2
        )  # pyvmaf: 71.13985273109745
        self.assertAlmostEqual(results[1]["VMAF_score"], 99.946416604585025, places=4)
    ...
    def test_run_vmaf_runner_float_vifks2(self):
        ...
        self.runner = VmafQualityRunner(
            ...
            optional_dict={
                "model_filepath": VmafConfig.test_resource_path(
                    "model", "vmaf_float_v0.6.1_vifks2.json"
                )
            },
            optional_dict2={"disable_avx": False},
        )
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale0_score"], 0.39857285405085036, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale1_score"], 0.9096751652352998, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale2_score"], 0.9539386820085598, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale3_score"], 0.9721655931648531, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_motion2_score"], 3.8943597291666667, places=4
        )
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_score"], 84.1901817483129, places=2
        )  # pyvmaf: 84.15127130907281
        self.assertAlmostEqual(results[1]["VMAF_score"], 99.946416604585025, places=4)
    ...
    def test_run_vmaf_runner_float_vifks2o3(self):
        ...
        self.runner = VmafQualityRunner(
            ...
            optional_dict={
                "model_filepath": VmafConfig.test_resource_path(
                    "model", "vmaf_float_v0.6.1_vifks2o3.json"
                )
            },
            optional_dict2={"disable_avx": False},
        )
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale0_score"], 0.35063512294952215, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale1_score"], 0.7008169620118055, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale2_score"], 0.8416977382019878, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale3_score"], 0.9083094326306004, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_motion2_score"], 3.8943597291666667, places=4
        )
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_score"], 75.77499080358565, places=2
        )  # pyvmaf: 72.97880576181906
        self.assertAlmostEqual(results[1]["VMAF_score"], 99.946416604585025, places=4)
    ...
    def test_run_vmaf_runner_with_param_neg(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_integer_feature_vif_scale1_score"], 0.7648294563297106, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_integer_feature_vif_scale2_score"], 0.8585079136153025, places=4
        )
        self.assertAlmostEqual(
    ...
    def test_run_vmaf_runner_with_param_neg_and_model_mfz(self):
        ...
        self.runner = VmafQualityRunner(
            ...
            optional_dict={
                ...
                "adm_enhn_gain_limit": 1.0,  # no effect
                "model_filepath": VmafConfig.model_path("other_models", "vmaf_v0.6.1mfz.json"),
            },
        )
        self.runner.run(parallelize=False)
