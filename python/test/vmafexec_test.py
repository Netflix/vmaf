...
class VmafexecQualityRunnerTest(unittest.TestCase):
    ...
    def test_run_vmafexec_runner_motion_force_zero(self):
        ...
        try: self.assertAlmostEqual(results[0]['VMAFEXEC_motion2_score'], 0.0, places=4)
        except AssertionError as e: self.verificationErrors.append(str(e))
        ...
        try: self.assertAlmostEqual(results[1]['VMAFEXEC_motion2_score'], 0.0, places=4)
        except AssertionError as e: self.verificationErrors.append(str(e))
        ...
        self.assertEqual(len(results[0]['VMAFEXEC_motion2_scores']), 48)
        self.assertEqual(len(results[1]['VMAFEXEC_motion2_scores']), 48)
    ...
    @unittest.skip("neg model prediction with override")
    def test_run_vmafexec_runner_akiyo_multiply_no_enhn_gain_model(self):
        ...
        self.assertAlmostEqual(results[0]['VMAFEXEC_VMAF_integer_feature_adm2_score_adm_enhn_gain_limit_1.20_score'], 0.9574308606115118, places=4)  # 1.116691484215469
