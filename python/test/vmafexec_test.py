...
class VmafexecQualityRunnerTest(MyTestCase):
    ...
    def test_run_vmafexec_runner_float_fex(self):
        ...
        self.assertAlmostEqual(results[0]['VMAFEXEC_score'], 76.66749952083335, places=4)
    ...
    def test_run_vmafexec_runner_set_custom_models(self):
        ...
        self.assertAlmostEqual(results[0]['VMAFEXEC_custom_vmaf_0_score'], 76.66749952083335, places=4)
        self.assertAlmostEqual(results[0]['VMAFEXEC_custom_vmaf_1_score'], 76.66749952083335, places=4)
    ...
    def test_run_vmafexec_runner_set_custom_models_enable_transform(self):
        ...
        self.assertAlmostEqual(results[0]['VMAFEXEC_standvmaf_score'], 76.66749952083335, places=4)
        self.assertAlmostEqual(results[0]['VMAFEXEC_phonevmaf_score'], 92.521434125, places=4)
