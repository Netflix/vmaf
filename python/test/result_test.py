...
class ResultTest(unittest.TestCase):
    ...
    def test_todataframe_fromdataframe(self):
        ...
        self.assertAlmostEquals(np.mean(df_adm.iloc[0]['scores']), 0.81386)
    ...
    def test_to_score_str(self):
        ...
        self.assertItemsEqual(self.result.moving_average('VMAF_legacy_scores',2), [45.76175145010879,45.76175145010879,45.76175145010879])
