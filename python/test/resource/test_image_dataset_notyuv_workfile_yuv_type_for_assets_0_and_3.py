...
dis_videos = [
    {'content_id': 0, 'asset_id': 0, 'dmos': 100, 'path': VmafConfig.resource_path('icpf', 'frame00000000.icpf'), 'workfile_yuv_type': 'yuv444p'}, # ref
    ...
    {'content_id': 1, 'asset_id': 3, 'dmos': 80,  'path': VmafConfig.resource_path('icpf', 'frame00000003.icpf'), 'workfile_yuv_type': 'yuv422p'},
]
