...
class AdmDwt2CyTest(unittest.TestCase):
    ...
    def test_adm_dwt2_cy_small(self):
        ...
        self.assertAlmostEqual(np.float(np.std(a)), 75.67939583965345, places=5)
        self.assertAlmostEqual(np.float(np.std(v)), 74.84364345847594, places=5)
        self.assertAlmostEqual(np.float(np.std(h)), 73.1595099161633, places=5)
        self.assertAlmostEqual(np.float(np.std(d)), 68.17639102914511, places=5)
    ...
    def test_adm_dwt2_cy_xsmall(self):
        ...
        self.assertAlmostEqual(np.float(np.std(a)), 68.79495062113115, places=5)
        self.assertAlmostEqual(np.float(np.std(v)), 67.96417675879844, places=5)
        self.assertAlmostEqual(np.float(np.std(h)), 75.05987575325626, places=5)
        self.assertAlmostEqual(np.float(np.std(d)), 62.93524366183755, places=5)
...
class AdmDwt2CyTestOnAkiyo(unittest.TestCase):
    ...
    def test_adm_dwt2_cy_on_akiyo_n_scales(self):
        ...
        self.assertEqual(h.shape, (18, 22))
        self.assertEqual(d.shape, (18, 22))
        self.assertAlmostEqual(np.float(np.std(a)), 800.3512673377832, places=5)
        self.assertAlmostEqual(np.float(np.std(v)), 133.36092909420165, places=5)
        self.assertAlmostEqual(np.float(np.std(h)), 113.7904328069727, places=5)
        self.assertAlmostEqual(np.float(np.std(d)), 47.651801810101496, places=5)
        ...
        self.assertEqual(h.shape, (9, 11))
        self.assertEqual(d.shape, (9, 11))
        self.assertAlmostEqual(np.float(np.std(a)), 1477.3950051168213, places=5)
        self.assertAlmostEqual(np.float(np.std(v)), 284.3777998557365, places=5)
        self.assertAlmostEqual(np.float(np.std(h)), 324.15282224075446, places=5)
        self.assertAlmostEqual(np.float(np.std(d)), 116.24440187217311, places=5)
...
class AdmDwt2CyTestOnAkiyoXsmall(unittest.TestCase):
    ...
    def test_adm_dwt2_cy_on_akiyo_single_scale(self):
        ...
        self.assertEqual(h.shape, (9, 11))
        self.assertEqual(d.shape, (9, 11))
        self.assertAlmostEqual(np.float(np.std(a)), 70.96065160084203, places=5)
        self.assertAlmostEqual(np.float(np.std(v)), 14.048580053657007, places=5)
        self.assertAlmostEqual(np.float(np.std(h)), 44.79487471014486, places=5)
        self.assertAlmostEqual(np.float(np.std(d)), 17.35515294883506, places=5)
        self.assertAlmostEqual(np.float(np.mean(a)), -75.84326395274935, places=5)
        self.assertAlmostEqual(np.float(np.mean(v)), -3.2531880028079962, places=5)
        self.assertAlmostEqual(np.float(np.mean(h)), 1.818506248770275, places=5)
        self.assertAlmostEqual(np.float(np.mean(d)), -0.3250551358064137, places=5)
