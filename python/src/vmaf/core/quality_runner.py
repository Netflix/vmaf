...
class VmafLegacyQualityRunner(QualityRunner):
    ...
    SVM_MODEL_FILE = config.VmafConfig.model_path("model_V8a.model")
...
class VmafQualityRunner(QualityRunner):
    ...
    # DEFAULT_MODEL_FILEPATH = config.VmafConfig.model_path("nflxall_vmafv1.pkl") # trained with resource/param/vmaf_v1.py on private/resource/dataset/NFLX_dataset.py (30 subjects)

    # VERSION = '0.2' # using model nflxall_vmafv2.pkl, VmafFeatureExtractor VERSION 0.2.1
    # DEFAULT_MODEL_FILEPATH = config.VmafConfig.model_path("nflxall_vmafv2.pkl") # trained with resource/param/vmaf_v2.py on private/resource/dataset/NFLX_dataset.py (30 subjects)

    # VERSION = '0.3' # using model nflxall_vmafv3.pkl, VmafFeatureExtractor VERSION 0.2.1
    # DEFAULT_MODEL_FILEPATH = config.VmafConfig.model_path("nflxall_vmafv3.pkl") # trained with resource/param/vmaf_v3.py on private/resource/dataset/NFLX_dataset.py (30 subjects)
    ...
    # DEFAULT_MODEL_FILEPATH = config.VmafConfig.model_path("nflxall_vmafv3a.pkl") # trained with resource/param/vmaf_v3.py on private/resource/dataset/NFLX_dataset.py (26 subjects)
    ...
    # ALGO_VERSION = 0
    # DEFAULT_MODEL_FILEPATH = config.VmafConfig.model_path("nflxall_vmafv4.pkl")  # trained with resource/param/vmaf_v4.py on private/resource/dataset/NFLX_dataset.py (26 subjects)
    ...
    DEFAULT_MODEL_FILEPATH = config.VmafConfig.model_path("vmaf_v0.6.1.pkl")
...
class VmafossExecQualityRunner(QualityRunner):
    ...
    # VERSION = '0.3'
    # DEFAULT_MODEL_FILEPATH_DOTMODEL = config.VmafConfig.model_path("nflxall_vmafv3.pkl.model")

    # VERSION = '0.3.1'
    # DEFAULT_MODEL_FILEPATH_DOTMODEL = config.VmafConfig.model_path("nflxall_vmafv3a.pkl.model")

    # VERSION = '0.3.2'
    # ALGO_VERSION = 0
    # # DEFAULT_MODEL_FILEPATH_DOTMODEL = config.VmafConfig.model_path("nflxall_vmafv4.pkl.model")
    # DEFAULT_MODEL_FILEPATH = config.VmafConfig.model_path("nflxall_vmafv4.pkl")
