...
By contributing your code, you agree to license your contribution under the terms of the [Apache License v2.0](https://opensource.org/licenses/BSDplusPatent). Your contributions should also include the following header:
...
│   ├── pthreads: pthreads C library used by Windows build
...
└── libvmaf: stand-alone C++ implementation of VMAF
```
