...
class FeatureTest(unittest.TestCase):
    ...
    def test_vif(self):
        ...
        self.assertAlmostEquals(score, 712650.023478, places=4)
        score, scores = read_log(VIF_LOG, "vif_den")
        self.assertAlmostEquals(score, 1597314.95249, places=4)
        score, scores = read_log(VIF_LOG, "vif_num_scale0")
        self.assertAlmostEquals(score, 468101.509766, places=4)
        score, scores = read_log(VIF_LOG, "vif_num_scale1")
        self.assertAlmostEquals(score, 184971.572266, places=4)
        score, scores = read_log(VIF_LOG, "vif_num_scale2")
        self.assertAlmostEquals(score, 47588.8323567, places=4)
        score, scores = read_log(VIF_LOG, "vif_num_scale3")
        self.assertAlmostEquals(score, 11988.1090902, places=4)
        score, scores = read_log(VIF_LOG, "vif_den_scale0")
        self.assertAlmostEquals(score, 1287822.80208, places=4)
        score, scores = read_log(VIF_LOG, "vif_den_scale1")
        self.assertAlmostEquals(score, 241255.067708, places=4)
        score, scores = read_log(VIF_LOG, "vif_den_scale2")
        self.assertAlmostEquals(score, 55149.8169759, places=4)
        score, scores = read_log(VIF_LOG, "vif_den_scale3")
        self.assertAlmostEquals(score, 13087.2657267, places=4)
    ...
    def test_ssim(self):
        ...
        self.assertAlmostEquals(score, 0.857692208333, places=4)
        self.assertAlmostEquals(scores[0], 0.923603, places=4)
        self.assertAlmostEquals(scores[1],  0.888209, places=4)
        score, scores = read_log(SSIM_LOG, "ssim_l")
        self.assertAlmostEquals(score, 0.9923925625, places=4)
        self.assertAlmostEquals(scores[0], 0.998127, places=4)
        self.assertAlmostEquals(scores[1], 0.995059, places=4)
        score, scores = read_log(SSIM_LOG, "ssim_c")
        self.assertAlmostEquals(score, 0.9611274375, places=4)
        self.assertAlmostEquals(scores[0], 0.979496, places=4)
        self.assertAlmostEquals(scores[1], 0.969685, places=4)
        score, scores = read_log(SSIM_LOG, "ssim_s")
        self.assertAlmostEquals(score, 0.897844791667, places=4)
        self.assertAlmostEquals(scores[0], 0.944064, places=4)
        self.assertAlmostEquals(scores[1], 0.919608, places=4)
    ...
    def test_ms_ssim(self):
        ...
        self.assertAlmostEquals(score, 0.9954706875, places=4)
        ...
        self.assertAlmostEquals(score, 0.997437458333, places=4)
        ...
        self.assertAlmostEquals(score, 0.998035583333, places=4)
        ...
        self.assertAlmostEquals(score,0.9995495, places=4)
...
class CornerCaseTest(unittest.TestCase):
    ...
    def test_checkerboard_identical(self):
        ...
        self.assertAlmostEquals(read_log(LOCAL_LOG_FILENAME, "vif_num_scale3")[0], 259774.958333, places=3)
    ...
    def test_checkerboard_shifted_by_1(self):
        ...
        self.assertAlmostEquals(read_log(LOCAL_LOG_FILENAME, "adm_den")[0], 30814.90966033333, places=3)
        self.assertAlmostEquals(read_log(LOCAL_LOG_FILENAME, "vif_num")[0], 5178894.51562, places=3)
        self.assertAlmostEquals(read_log(LOCAL_LOG_FILENAME, "vif_den")[0], 33021387.0625, places=3)
        self.assertAlmostEquals(read_log(LOCAL_LOG_FILENAME, "anpsnr")[0], 16.669074, places=4)
        self.assertAlmostEquals(read_log(LOCAL_LOG_FILENAME, "vif_num_scale0")[0], 2908829.0, places=3)
        self.assertAlmostEquals(read_log(LOCAL_LOG_FILENAME, "vif_den_scale0")[0], 25757473.3333, places=3)
        self.assertAlmostEquals(read_log(LOCAL_LOG_FILENAME, "vif_num_scale3")[0], 128957.796875, places=3)
        self.assertAlmostEquals(read_log(LOCAL_LOG_FILENAME, "vif_den_scale3")[0], 259774.9375, places=3)
    ...
    def test_flat_identical(self):
        ...
        self.assertAlmostEquals(read_log(LOCAL_LOG_FILENAME, "vif_num")[0], 2754000.15625, places=4)
    ...
    def test_flat_value10(self):
        ...
        self.assertAlmostEquals(read_log(LOCAL_LOG_FILENAME, "adm_num")[0], 0.0, places=4)
        self.assertAlmostEquals(read_log(LOCAL_LOG_FILENAME, "adm_den")[0], 0.0, places=4)
        self.assertAlmostEquals(read_log(LOCAL_LOG_FILENAME, "vif_num")[0], 2753999.99219, places=4)
        self.assertAlmostEquals(read_log(LOCAL_LOG_FILENAME, "vif_den")[0], 2754000.0, places=4)
