...
{ \
        ...
        src_ptr2 += src_stride; \
        flt_ptr2 += src_stride; \
        __m256i src01 = _mm256_cvtepu32_epi64(_mm_loadu_si128((__m128i*)(src_ptr0 + j - 1))); \
        __m256i src11 = _mm256_cvtepu32_epi64(_mm_loadu_si128((__m128i*)(src_ptr1 + j - 1))); \
        __m256i src21 = _mm256_cvtepu32_epi64(_mm_loadu_si128((__m128i*)(src_ptr2 + j - 1))); \
        src01 = _mm256_abs_epi32(src01); \
        src11 = _mm256_abs_epi32(src11); \
        src21 = _mm256_abs_epi32(src21); \
