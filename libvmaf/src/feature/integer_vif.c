                ...
                unsigned bpc, unsigned w, unsigned h)
{
    ...
    s->public.buf.data           = (void *)data; data += pad_size;
    s->public.buf.ref            = (void *)data; data += frame_size + pad_size + pad_size;
    s->public.buf.dis            = (void *)data; data += frame_size + pad_size;
