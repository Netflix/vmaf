 ...
 *
 *  This file supersedes integer_ssim_cuda.c (which carried a
 *  misleading name despite being a pure-float implementation).
 *  The kernel in integer_ssim/ssim_score.cu is shared via
 *  the ssim_score_ptx symbol declared in float_ssim_cuda.h.
 */
                           ...
                           VmafPicture *dist_pic, VmafPicture *dist_pic_90, unsigned index)
{
    ...
    /* Pass 1 — horizontal. Grid sized over (W-10) x H. */
     ...
     * (W-10) x (H-10). The horiz pass writes happen-before
