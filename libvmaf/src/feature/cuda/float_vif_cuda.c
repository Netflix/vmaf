...
typedef struct FloatVifStateCuda {
    ...
    bool vif_skip_scale0; /* host-side suppression mirrors float_vif.c */
                            ...
                            VmafFeatureCollector *feature_collector)
{
    ...
    int err = 0;
    /* vif_skip_scale0: emit 0.0 for scale0 and exclude it from the
     * combined num/den totals — mirrors float_vif.c write_scores(). */
