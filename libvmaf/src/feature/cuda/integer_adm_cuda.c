...
static const VmafOption options_cuda[] = {
    ...
    },
    {
        ...
        .alias = "ss0",
        .help = "skip scale 0 contribution: exclude scale-0 num/den from the "
                "overall ADM score and emit 0.0 for integer_adm_scale0 "
                "(host-side suppression; GPU still computes scale 0)",
